        ...
        <div class="row">
          <div class="col-lg-12 m-auto">
            <div class="card">
                 ...
                 <div class="card-body">
                   <form class="" action="{{route('page.update',$data->id)}}" method="post">
                     @csrf
                     ...
                     <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="page_name" value="{{$data->page_name}}" placeholder="Page Name">
                     </div>
                     <div class="form-group">
                       <label for="">Page Title</label>
                       <input type="text" class="form-control" name="page_title" value="{{$data->page_title}}" placeholder="Page Title">
                     </div>
                     <div class="form-group">
                       <label for="">Page Description</label>
                       <textarea name="description" class="form-control textarea" rows="8" cols="80">{{$data->description}}</textarea>
                     </div>
