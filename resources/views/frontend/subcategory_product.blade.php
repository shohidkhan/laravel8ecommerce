			...
			<div class="row">
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span>{{count($subcategory_wise_products)}}</span> products found</div>
						...
						<div class="product_grid row">
							...
							<!-- Product Item -->
              @foreach($subcategory_wise_products as $row)
              ...
              @endforeach
						...
						<div class="shop_page_nav d-flex flex-row">
							{{ $subcategory_wise_products->links() }}
						</div>
